class OrdersController < ApplicationController
  ...
  def order_params
    params.require(:order_student_detail).permit(:ryugaku_experience_id ,:english_test_id).merge(student_id: current_student.id, lesson_id:params[:lesson_id], token:params[:token])
  end
