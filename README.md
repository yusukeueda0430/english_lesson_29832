...
ログインしていなくても、出品されているレッスンの出品画像、レッスン名、料金を一覧で見ることができる

## レッスン出品機能

【ボタン】

ログインしていると、出品ボタンと戻るボタンがある

【表示】

ログインしていると、画面が表示され、出品画像、レッスン名、レッスンの説明と自己紹介、カテゴリ、居住地、留学経験、海外在住歴、レッスンの回数と曜日と開始時間、終了時間、料金を入力するフォームがある

## レッスン詳細機能

【ボタン】

出品者の場合は、編集ボタンと削除ボタン。出品者でない場合は購入画面に進むボタン

【表示】

ログインしていなくても、出品画像、レッスン名、レッスンの説明と自己紹介、カテゴリ、居住地、留学経験、海外在住歴、レッスンの回数と曜日と開始時間、終了時間、料金を見ることができる
  
## レッスン編集機能

【ボタン】

ログインしていて、出品者なら、変更するボタンと戻るボタン

【表示】

ログインしていて、出品者なら、画面が表示され、出品画像、レッスン名、レッスンの説明と自己紹介、カテゴリ、居住地、留学経験、海外在住歴、レッスンの回数と曜日と開始時間、終了時間、料金を入力するフォームがある
  
## レッスン購入機能

【ボタン】

ログインしていて、出品者でないなら、購入ボタンがある

【表示】

ログインしていて、出品者でないなら、「出品画像、レッスン名、料金」の表示、クレジットカード情報を入力するフォームがある

## レッスン削除機能

画面なし

ログインしていて、出品者でないなら、できる
...
# 実装した機能についてのGIFと説明
  ...
  ログインしていれば、全ての項目を入力するだけで、誰でも自由にレッスンを作り、出品できる

  ## レッスン詳細機能

  詳細についてはログインしていても、していなくても見ることができる

  出品者がログインしていれば、編集ページに進んだり、削除したりできる

  出品者でない方がログインしていれば、購入ページに進める

  ## レッスン編集機能

  出品者がログインしていると、出品と同様の画面で編集できる

  ## レッスン購入機能

  出品者でない方がログインしていると、クレジットカードの情報を入力することで、好きなレッスンを購入できる

  ## レッスン削除機能

  出品者がログインしていると、レッスンを削除できる
